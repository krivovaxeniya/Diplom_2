...
def get_ingredients():
    response = requests.get(f'{Data.burger_main}{Data.endpoint_ingredients}')
...
def create_user_and_create_order():
    ...
    response = requests.post(f'{Data.burger_main}{Data.endpoint_order}', headers={'Authorization': user_data.get("token")}, data=payload)
